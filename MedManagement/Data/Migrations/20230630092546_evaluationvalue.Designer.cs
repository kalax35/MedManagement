...
namespace MedManagement.Data.Migrations
{
    ...
    [Migration("20230630092546_evaluationvalue")]
    partial class evaluationvalue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedManagement.Data.DiseasesTreated", b =>
                {
                    b.Property<int>("DiseasesTreatedID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("DiseasesTreatedID"));
            ...
            modelBuilder.Entity("MedManagement.Data.Doctor", b =>
                {
                    ...
                    b.Property<string>("DoctorAboutMe")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DoctorMedicalSpecialization")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MedManagement.Data.Evaluation", b =>
                {
                    ...
                    b.Property<string>("EvaluationDesctyption")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("EvaluationValue")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MedManagement.Data.DiseasesTreated", b =>
                {
                    b.HasOne("MedManagement.Data.Doctor", "Doctor")
                        .WithMany("DiseasesTreated")
            ...
            modelBuilder.Entity("MedManagement.Data.Doctor", b =>
                {
                    b.HasOne("MedManagement.Data.MedicalFacility", null)
                        .WithMany("Doctor")
            ...
            modelBuilder.Entity("MedManagement.Data.DoctorMedicalFacility", b =>
                {
                    b.HasOne("MedManagement.Data.Doctor", "Doctor")
                        .WithMany("DoctorMedicalFacility")
                        .HasForeignKey("DoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MedManagement.Data.MedicalFacility", "MedicalFacility")
                        .WithMany("DoctorMedicalFacility")
                        .HasForeignKey("MedicalFacilityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MedManagement.Data.Evaluation", b =>
                {
                    ...
                    b.HasOne("MedManagement.Data.Patient", "Patient")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MedManagement.Data.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MedManagement.Data.Doctor", b =>
                {
                    b.Navigation("DiseasesTreated");

                    b.Navigation("DoctorMedicalFacility");
